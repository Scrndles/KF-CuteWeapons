class No5MkIEnfieldFire extends KFFire;
...
defaultproperties
{
     FireSoundRef="CuteWeaponPack_Snd.No5MkIEnfield_Snd.No5MkIEnfield_Fire_M"
     StereoFireSoundRef="CuteWeaponPack_Snd.No5MkIEnfield_Snd.No5MkIEnfield_Fire_S"
     NoAmmoSoundRef="KF_RifleSnd.Rifle_DryFire"
	 TweenTime=0.005
     FireAimedAnim="Fire_Iron"
     RecoilRate=0.200000 //0.1
     maxVerticalRecoilAngle=1200
     maxHorizontalRecoilAngle=250
     DamageType=Class'CuteWeapons.DamTypeNo5MkIEnfield'
	 DamageMin=100
	 DamageMax=125
     ...
     FireRate=0.9000 //0.95
     FireAnimRate=1.1
     AmmoClass=Class'CuteWeapons.No5MkIEnfieldAmmo'
	 AmmoPerFire=1
	 BotRefireRate=0.650000
	 FlashEmitterClass=Class'ROEffects.MuzzleFlash1stKar'
     
     ShellEjectClass=Class'CuteWeapons.ShellEjectEnfield'
